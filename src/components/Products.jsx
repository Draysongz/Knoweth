...
AccordionPanel,
AccordionIcon,
Spacer,Drawer,DrawerContent,DrawerOverlay,DrawerBody, DrawerCloseButton,useDisclosure, Input
...
<Flex bgColor={'#0066B2'} minH={'50vh'} minW={'60vw'} w={['99.9vw', '100vw', '100vw', '98.7vw']} overflowX={'hidden'}  >
        <Flex direction='column' py={'8rem'} gap={5} w={'99vw'}  >
        <Center >
            <Box  textAlign={'center'}  minW={'60vw'} >
                <Heading width={['80vw', '70vw', '70vw', '58vw']} fontSize={['20px', '24px', '36px']}
                 color={'white'}>Our Products</Heading>
            ...
            <Center>
                <Box textAlign={'center'}>
                    <Text width={'45vw'} display={['none', 'none', 'none', 'block']} color={'white'}>Knoweth helps you spy on your competitors&apos;
                     ads, write compelling copies, or plan & organize your task</Text>
                </Box>
                </Center>
            ...
            <Center>
                <Flex gap={4} direction={['column', 'column', 'column', 'row']}>
                    ...
                    borderRadius={'md'} 
                    fontSize={'md'}
                    color={'#0066B2'}>Start spying with Knoweth</Button>
                    <Button borderRadius={'md'}
                    color={'white'}
                    leftIcon={<FiPlay/>}
                    fontSize={'md'} border={'0.8px solid #F8F8F8'} variant={'outline'}> Watch How it works</Button>
                </Flex>
            </Center>
    ...
    <Flex   w={['100vw', '100vw', '98.7vw']} bgColor={'#fff'} 
    p={10} gap={5} direction={'column'}>
      <Heading fontSize={['md', 'md', '4xl']} textAlign={'center'}>Frequently Asked Questions (FAQ)</Heading>
